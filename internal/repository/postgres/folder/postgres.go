...
import (
	...
	"github.com/rs/xid"
	"github.com/tupyy/folder-manager/internal/repository/models"
	"github.com/tupyy/folder-manager/pkg/entity"
	"go.uber.org/zap"
	"gorm.io/gorm"
)
...
func (a *FolderRepo) Create(ctx context.Context, album entity.Album) (entity.Album, error) {
	m := toModel(album)
	m.ID = xid.New().String()
	album.ID = m.ID
...
func (a *FolderRepo) Delete(ctx context.Context, id string) error {
...
func (a *FolderRepo) Update(ctx context.Context, album entity.Album) (entity.Album, error) {
	if !a.circuitBreaker.IsAvailable() {
...
func (a *FolderRepo) Get(ctx context.Context) ([]entity.Album, error) {
	if !a.circuitBreaker.IsAvailable() {
...
func (a *FolderRepo) GetByID(ctx context.Context, id string) (entity.Album, error) {
	if !a.circuitBreaker.IsAvailable() {
...
func (a *FolderRepo) GetByOwner(ctx context.Context, owner string) ([]entity.Album, error) {
	if !a.circuitBreaker.IsAvailable() {
...
func (a *FolderRepo) GetByUser(ctx context.Context, username string) ([]entity.Album, error) {
	if !a.circuitBreaker.IsAvailable() {
...
func (a *FolderRepo) GetByGroupName(ctx context.Context, groupName string) ([]entity.Album, error) {
	if !a.circuitBreaker.IsAvailable() {
...
func (a *FolderRepo) GetByGroups(ctx context.Context, groupNames []string) ([]entity.Album, error) {
	if !a.circuitBreaker.IsAvailable() {
...
func (a *FolderRepo) SetPermissions(ctx context.Context, albumId string, permissions []entity.AlbumPermission) error {
	if !a.circuitBreaker.IsAvailable() {
...
func (a *FolderRepo) RemovePermissions(ctx context.Context, albumId string) error {
	if !a.circuitBreaker.IsAvailable() {
...
func (a *FolderRepo) checkNetworkError(err error) (isOpen bool) {
