...
*/
func (a *VersionsApiService) GetVersionMetadata(ctx _context.Context) (VersionMetadata, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/gphotos/v1"
